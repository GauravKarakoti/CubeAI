...
def option_recommender():
    ...
    ShowTextToScreen(f"{Assistantname}: Choose Genral Recomendation or Specialized Recomendation")
    ...
    if  "general" in response.lower():
        main()
    elif "specialized" in response.lower():
        Career_Recomendation()
    else:
        TextToSpeech("Please Choose General Recomendation or Specialized Recomendation")
        option_recommender()
